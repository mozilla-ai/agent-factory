...
{{
    "answer": "The answer to the user's question, generated by the agent. Use this field to return simple text answers to the user,
        if you want more information or no you're just chatting with them.",
    "final_answer": "Whether the agent has provided a final answer to the user's question. Set this to True,
        if the agent has completed the user assigned task and provided the agent_instructions, tools,
        imports, structured_outputs, cli_args, agent_description, prompt_template, readme and dependencies.
        Set this to False, othewise.",
