...
def extract_requirements_from_string(python_code: str) -> list[str]:
...
def prepare_agent_artifacts(agent_factory_outputs: dict[str, str]) -> dict[str, str]:
    ...
    dependencies = extract_requirements_from_string(agent_code)
    validated_dependencies = validate_dependencies(agent_factory_outputs["tools"], dependencies)
