...
code that will solve the task. Fill the `answer` field with a confirmation saying "✅ Done! Your agent is ready!", and
set `code_ready` to `True`.
"""
...
4. If you are ready to generate the agent code, you can fill the `answer` field with a confirmation
   saying "✅ Done! Your agent is ready!", and set `code_ready` to `True`. Also fill the
